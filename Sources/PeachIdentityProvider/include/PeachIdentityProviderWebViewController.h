 ...
 */
@interface PeachIdentityProviderWebViewController : UIViewController <WKNavigationDelegate, UIScrollViewDelegate>
 ...
 */
- (id)initWithRequest:(NSURLRequest *)request decisionHandler:(WKNavigationActionPolicy (^ _Nullable)(NSURL *URL))decisionHandler;
